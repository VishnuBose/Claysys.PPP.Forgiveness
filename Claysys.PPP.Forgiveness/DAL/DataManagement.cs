...
namespace Claysys.PPP.Forgiveness.DAL
{
    public class DataManagement
    {
        ...
        public SbaForgiveness fillData(SqlDataReader reader)
        {
            ...
            sbaForgivenessObj.flLoanNumber = Convert.ToInt64(reader["LenderPPPLoanNumber"].ToString());
            ...
            sbaForgivenessObj.einSsn = Convert.ToInt32(Convert.ToString(reader["TINNumber"]).Replace("-", ""));
            ...
            sbaForgivenessObj.forgive_eidl_application_number = Int64.TryParse(Convert.ToString(reader["EIDLApplicationNumber"]), out intValue) ? intValue : 0;
